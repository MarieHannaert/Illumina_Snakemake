...
This repository is a snakemake workflow that can be used to analyze short-read data specific for bacterial genomes using Illumina. Everything needed can be found in this repository. I made this pipeline during my traineeship by ILVO-Plant. 
...
#### Kraken2
Kraken will also start from the sample. It will generate a report file for each sample. 
